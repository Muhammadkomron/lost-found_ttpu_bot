# Generated by Django 4.1.1 on 2022-10-22 19:12
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('pending_item_list', models.CharField(blank=True, max_length=100, null=True)),
                ('pending_item_list_cancel', models.CharField(blank=True, max_length=100, null=True)),
                ('active_item_list', models.CharField(blank=True, max_length=100, null=True)),
                ('active_item_list_cancel', models.CharField(blank=True, max_length=100, null=True)),
                ...
                ('item_list_exception_text', models.TextField(blank=True, null=True)),
                ('active_item_list_exception_text', models.TextField(blank=True, null=True)),
                ('pending_item_list_exception_text', models.TextField(blank=True, null=True)),
                ('item_status_text', models.TextField(blank=True, null=True)),
                ('item_status_created_text', models.TextField(blank=True, null=True)),
                ('item_status_published_text', models.TextField(blank=True, null=True)),
                ('item_status_delivered_text', models.TextField(blank=True, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.IntegerField(choices=[(1, 'Created'), (2, 'Published'), (3, 'Delivered'), (4, 'Cancelled'), (5, 'Rejected'), (6, 'Blocked')], default=1)),
                ('message_id', models.IntegerField(blank=True, null=True)),
